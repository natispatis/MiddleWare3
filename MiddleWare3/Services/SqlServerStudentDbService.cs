...
namespace MiddleWare3.Services
{
    public class SqlServerStudentDbService : IStudentDbService
    {
        public Students GetStudent(string Index)
        {
            ...
            using (var connection = new SqlConnection("Data Source=db-mssql;Initial Catalog=s18444;Integrated Security=True"))
        ...
        public List<Students> GetStudents()
        {
            ...
            using (var client = new SqlConnection("Data Source=db-mssql;Initial Catalog=s18444;Integrated Security=True"))
